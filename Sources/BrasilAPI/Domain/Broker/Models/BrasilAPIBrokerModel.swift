...
public struct BrasilAPIBrokerModel: Codable {
    let cnpj: String
    let type: String
...
enum Status: String, Codable {
    ...
    case emFuncionamentoNormal = "EM FUNCIONAMENTO NORMAL"
    case incorporação = "INCORPORAÇÃO"
    case liquidaçãoExtrajudicial = "LIQUIDAÇÃO EXTRAJUDICIAL"
}
